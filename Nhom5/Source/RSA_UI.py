...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gbtnResult.setGeometry(QtCore.QRect(10, 190, 581, 481))
        ...
        self.lbphiN = QtWidgets.QLabel(self.gbtnResult)
        self.lbphiN.setGeometry(QtCore.QRect(10, 100, 101, 30))
        font = QtGui.QFont()
        font.setFamily("JetBrains Mono")
        font.setPointSize(10)
        self.lbphiN.setFont(font)
        self.lbphiN.setAlignment(QtCore.Qt.AlignCenter)
        self.lbphiN.setObjectName("lbphiN")
        self.txtPhiN = QtWidgets.QTextEdit(self.gbtnResult)
        self.txtPhiN.setGeometry(QtCore.QRect(130, 100, 441, 30))
        font = QtGui.QFont()
        font.setFamily("JetBrains Mono")
        font.setPointSize(10)
        self.txtPhiN.setFont(font)
        self.txtPhiN.setReadOnly(True)
        self.txtPhiN.setObjectName("txtPhiN")
        self.lbE = QtWidgets.QLabel(self.gbtnResult)
        self.lbE.setGeometry(QtCore.QRect(10, 140, 101, 30))
        font = QtGui.QFont()
        font.setFamily("JetBrains Mono")
        font.setPointSize(10)
        ...
        self.txtE.setGeometry(QtCore.QRect(130, 140, 441, 30))
        font = QtGui.QFont()
        font.setFamily("JetBrains Mono")
        font.setPointSize(10)
        ...
        self.lbD.setGeometry(QtCore.QRect(10, 180, 101, 30))
        font = QtGui.QFont()
        font.setFamily("JetBrains Mono")
        font.setPointSize(10)
        ...
        self.txtD.setGeometry(QtCore.QRect(130, 180, 441, 30))
        font = QtGui.QFont()
        font.setFamily("JetBrains Mono")
        font.setPointSize(10)
        ...
        self.lbEnc.setGeometry(QtCore.QRect(10, 260, 101, 101))
        font = QtGui.QFont()
        font.setFamily("JetBrains Mono")
        font.setPointSize(10)
        ...
        self.txtEnc.setGeometry(QtCore.QRect(130, 260, 441, 100))
        font = QtGui.QFont()
        font.setFamily("JetBrains Mono")
        font.setPointSize(10)
        ...
        self.lbDes.setGeometry(QtCore.QRect(10, 370, 101, 101))
        font = QtGui.QFont()
        font.setFamily("JetBrains Mono")
        font.setPointSize(10)
        ...
        self.txtDes.setGeometry(QtCore.QRect(130, 370, 441, 100))
        font = QtGui.QFont()
        font.setFamily("JetBrains Mono")
        font.setPointSize(10)
        ...
        self.lbN.setGeometry(QtCore.QRect(10, 220, 101, 30))
        font = QtGui.QFont()
        font.setFamily("JetBrains Mono")
        font.setPointSize(10)
        ...
        self.txtN.setGeometry(QtCore.QRect(130, 220, 441, 30))
        font = QtGui.QFont()
        font.setFamily("JetBrains Mono")
        font.setPointSize(10)
...
# Kết nối với lại file giải thuật RSA
    def result(self):
        ...
        self.txtPhiN.setText(str(self.rsa.phiN))
